                            ...
                            <Box sx={{ width: '50vh', p: 3, textAlign: 'center', m: '0 auto' }}>
                                <Card sx={{ borderRadius: 2, p: 2 }}>
                                    <CardContent>
                                        ...
                                        <Typography variant="subtitle2" sx={{ mb: 1, fontWeight: 600, color: order.status === 'cancelled' ? 'error.main' : order.status === 'confirmed' ? 'success.main' : 'warning.main', letterSpacing: 1 }}>
                                    ...
                                    <CardActions sx={{ justifyContent: 'center' }}>
                                        <Button 
                                            ...
                                            disabled={order.status && order.status.toLowerCase() === 'confirmed'}
                                        >
                                            Cancel Order
                                        </Button>
                                    </CardActions>
